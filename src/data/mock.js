/**
 * Small pieces of illustrative sample data that aren't yet backed
 * by the store (class timetable — no scheduling model exists yet).
 * Everything else (users, resources, attendance, chats, exam
 * results) is real, persisted data — see src/store/db.js.
 */
